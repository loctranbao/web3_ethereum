/// let pepple enter raffle with entrance fee
/// Run automatically after an interval
/// Automatically pick a random winner
/// Automatically transfer all ether in the contract to the winner
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface{
    ...
    function checkUpkeep(bytes calldata /* checkData */) public view override returns (bool upkeepNeeded, bytes memory performData) {
        ...
        upkeepNeeded = timePassed && hasPlayer && hasBalance && isOpen;
